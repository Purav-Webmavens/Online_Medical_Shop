...
<link href="https://fonts.googleapis.com/css2?family=Maven+Pro:wght@400&display=swap" rel="stylesheet"></head>
...
<body>
  ...
  <div class="col-sm-6 col-md-5">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title" style="font-weight:700;">Your Orders</h5>
        <p class="card-text">You Can Check Your Wallet Balance And Transfer Money In Wallet From Your Bank.</p>
        <a href="#" class="btn btn-danger">Your Orders</a>
      </div>
    </div>
  </div>
</div><br><br>
