...
<div class="row">
  <div class="col-sm-3" >
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">He is Heart Speialist. Book Your Appointment To  </p>
   ...
   <div class="col-sm-3">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text"></p>
        <a href="#" class="btn btn-primary c">Book Appointment</a>
      </div>
    </div>
  </div>
   <div class="col-sm-3">
  ...
  <div class="col-sm-3">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title"><b>Dr. WAD JAVA</b></h5>
        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
        <a href="#" class="btn btn-primary c">Book Appointment</a>
      </div>
    </div>
