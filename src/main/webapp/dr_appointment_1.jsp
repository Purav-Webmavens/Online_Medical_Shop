...
<i class="fas fa-user-md fa-lg me-3 fa-fw "></i>
						<select class="select form-control " name="doc"
							style="margin-left: 42px; margin-top: -37px; width: 92%;" required>
							<option value="1" disabled>Doctor's Name</option>
							<option value="jiany">Dr. Jinay Shah</option>
							<option value="purav">Dr. Purav Shah</option>
							<option value="tirth">Dr. Tirth Patel</option>
							<option value="wad">Dr. WAD JAVA</option>
							</select>
				<div class="d-flex flex-row align-items-center mb-4 " style="margin-top:20px;">
					<i class="fas fa-user fa-lg me-3 fa-fw"></i>
					<div class="form-outline flex-fill mb-0">
						<input type="text" id="form3Example1c" class="form-control" name="pn" required/> <label
							class="form-label" for="form3Example1c">Patient Name</label>
					</div>
				</div>
				...
				<div class="d-flex flex-row align-items-center mb-4">
					...
					<div class="form-outline flex-fill mb-0">
						<input type="date" id="form3Example3c" class="form-control" min=<%=java.time.LocalDate.now()%> name="date" required/> <label
				...
				<div class="d-flex flex-row align-items-center mb-4">
					...
					<div class="form-outline flex-fill mb-0">
						<input type="time" id="form3Example3c" class="form-control"  min="10:00" max="20:00" name="time" required/> <label
