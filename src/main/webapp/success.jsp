...
<div class="card" style="text-align:center;border:none;box-shadow:none;">
 <br><br><br><br>
  <div class="card-body">
    ...
    <h4 class="card-text">Payment Of Rs.<%=request.getAttribute("ammount") %>
 Done Successfully</h4>
  </div>
</div><br><br>
<div class="text-center"><a href="wallet.jsp"><button class="btn" style="text-transform:capitalize;background:#3BB896;color:#fff">Go Back</button></a></div>
</body>
</html>