        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;background:none;">
            <div class="card-body p-5">
              ...
              <form action="change_acc_pass_logic.jsp" method="post">
                ...
                <div class="form-outline mb-4">
                 ...
                 <div class="form-outline mb-4">
                  <input type="password" id="form3Example3cg" class="form-control form-control-lg" name="old_pass" required/>
                  <label class="form-label" for="form3Example3cg">Old Password</label>
                </div>
                <div class="form-outline mb-4">
                  <input type="password" id="form3Example3cg" class="form-control form-control-lg" name="new_pass" required/>
                  <label class="form-label" for="form3Example3cg">New Password</label>
                </div>


                <div class="d-flex justify-content-center">
                  <button type="submit" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" style="color:#fff !important;background:#3bb896;">Submit</button>
                </div>
				<a href="account.jsp" style="color:#000;"><br>Go back to your account</a>
              </form>
