						...
						<div class="card-body p-4">
							...
							<div class="row">
											...
											<div class="card-body">
												<div class="d-flex justify-content-between">
													<div class="d-flex flex-row align-items-center">
														<div>
														<c:set var="img" value="${param.count_image }"></c:set>
								...
								<div class="col-lg-5">
									...
									<div class="card bg-primary text-white" style="box-shadow:none;">
									<form action="cart_wallet_logic.jsp" mthod="post">
										<div class="card-body" style="background: #38a688;">
											...
											<form class="mt-4">
												<div class="form-outline form-white mb-4">
													<input type="text" id="typeName"
														...
														placeholder="Name" /> <label class="form-label"
														for="typeName">Account Holder's Name</label>
												</div>

												<div class="form-outline form-white mb-4">
													<input type="text" id="typeText"
														class="form-control form-control-lg" siez="17"
														placeholder="" minlength="19" maxlength="19" /> <label
														class="form-label" for="typeText">PIN Number</label>
												</div>
											...
											<button type="submit" class="btn btn-block btn-lg"
												...
												<div class="d-flex justify-content-between">
													<span>&#8377;&nbsp;<%=fina%></span> <span>Checkout <i
														class="fas fa-long-arrow-alt-right ms-2"></i>
													</span>
												</div>
											</button>
											<input type="hidden" name="final" value="<%=fina%>">
