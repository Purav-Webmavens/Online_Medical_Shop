...
<div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img src="images/slider_1.jpg" class="d-block w-100" alt="Sunset Over the City"/>
      
    </div>

    <!-- Single item -->
    <div class="carousel-item">
      <img src="images/slider_2.jpg" class="d-block w-100" alt="Canyon at Nigh"/>
...
<div class="card-group">
  ...
  <div class="card card_3" style="border-radius: 20px;height: 180px;margin-left: 20px ;">
    ...
    <div class="card-body">
      <button type="button" class="btn btn-primary" style="font-size:12px !important;">Book Now</button>
    </div>
  </div>
</div><br><br><br><br>

<!--Slider2-->
<h1 style="text-align:center;letter-spacing: 1px;color: #000;font-family:'Mavens Pro';font-size:30px;font-weight:700;">&nbsp;&nbsp;&nbsp;&nbsp;MAIN PRODUCTS</h1><br>

      <div class="card-group five-banner" style="outline: none !important;font-family: 'Outfit', sans-serif;" >
        <div class="card border-0 one" style="box-shadow: none;margin-left: 100px;"><br><br>
          ...
          <div class="card-body">
            <h4 class="card-title" style="color: #000;">Azythromycine </h4>
          </div>
        </div>
