          ...
          <div class="card" style="border-radius: 15px;background:none;">
            <div class="card-body p-5">
              ...
              <form action="forget_password_logic.jsp" method="post">
                ...
                <div class="form-outline mb-4">
                  <input type="password" id="form3Example3cg" class="form-control form-control-lg" name="Key" required/>
                  <label class="form-label" for="form3Example3cg">Your Security Key</label>
                </div>
                 <div class="form-outline mb-4">
                  <input type="password" id="form3Example3cg" class="form-control form-control-lg" name="pass" required/>
                  <label class="form-label" for="form3Example3cg">New Password</label>
                </div>


                <div class="d-flex justify-content-center">
                  <button type="submit" class="btn btn-primary btn-block btn-lg gradient-custom-4 text-body" style="color:#fff !important;">Submit</button>
                </div>
				<a href="login.jsp" style="color:#000;"><br>Go back to login Page</a>
              </form>
