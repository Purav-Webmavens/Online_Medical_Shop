...
<body>
	<%
		...
		if(doc.equals("jiany"))
		{
			...
			{
				p.executeUpdate();
				RequestDispatcher rd=request.getRequestDispatcher("sucess_doc_1.jsp");
			...
			else
			{
				while(rs1.next())
				{
					...
					{
						out.print("<h3 style=\"margin-top:-62vw;text-align:center;margin-left:50vw;color:red;\">Slot not Available</h3>");
