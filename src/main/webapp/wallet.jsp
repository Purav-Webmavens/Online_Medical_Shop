...
<h2>How To Create A Loader</h2>
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="card">
				<div class="card-body">
					<h3 style="color: #000; text-align: center; margin-top: -80px;">Transfer
						Money</h3>
					<br>
					<br>
						...
						<div class="d-flex flex-row align-items-center mb-4">
							...
							<div class="form-outline flex-fill mb-0">
								<input type="number" id="form3Example1c" class="form-control"
									name="amount" /> <label class="form-label" for="form3Example1c">Ammount</label>
							</div>
						</div>
		...
		<div class="col-sm-6 wallet">
			<div class="card">
				<div class="card-body">
					...
					<h3 class="card-title"
						style="color: #000 !important; text-align: center; margin-top: -80px;">Wallet</h3>
						<%
