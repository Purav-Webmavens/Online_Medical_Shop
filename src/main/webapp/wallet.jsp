...
<body>
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="card">
				<div class="card-body">
					<h3 style="color: #000; text-align: center; margin-top: -80px;"><br>
	<br>Transfer
						Money</h3>
					<br>
					<br>
					...
					<form class="mx-1 mx-md-4" 
						action="wallet_logic.jsp" method="post"
						...
						<div class="d-flex flex-row align-items-center mb-4">
							...
							<div class="form-outline flex-fill mb-0">
								<input type="text" id="form3Example1c" class="form-control"
									name="Name" required/> <label class="form-label" for="form3Example1c" >Your
									Name</label>
							</div>
						</div>
						...
						<div class="d-flex flex-row align-items-center mb-4">
							...
							<div class="form-outline flex-fill mb-0">
								<input type="number" id="form3Example3c" class="form-control"
									name="Acc" required /> <label class="form-label" for="form3Example3c">Your
						...
						<div class="d-flex flex-row align-items-center mb-4">
							...
							<div class="form-outline flex-fill mb-0">
								<input type="password" id="form3Example3c" class="form-control"
									name="pc" required/> <label class="form-label" for="form3Example3c">Your
									Pass Code</label>
							</div>
						</div>
						...
						<i class="fas fa-bank"
							style="font-size: 25px; padding-bottom: -10px;"></i> 
							<select class="select form-control" name="bank"
						...
						<div class="d-flex flex-row align-items-center mb-4">
							...
							<div class="form-outline flex-fill mb-0">
								<input type="number" id="form3Example1c" class="form-control"
									name="amount" required/> <label class="form-label" for="form3Example1c">Ammount</label>
							</div>
						</div>
						...
						<div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4"
							...
							<button type="submit" class="btn btn btn-lg" style="background:#38A688;color:#fff">Transfer</button>
						</div>
		...
		<div class="col-sm-6 wallet">
			<div class="card">
				<div class="card-body">
					...
					<h3 class="card-title"
						style="color: #000 !important; text-align: center;margin-top:-15px;">Wallet</h3>
						<%
								...
								if(((String)session.getAttribute("Username")).equals(rs.getString("Name")))
							{
								...
								out.print("<h4 style=\"font-weight:700;text-align:center;margin-top:30px;\">Your Wallet:<a style=\"text-align:center;font-weight:400;font-family:arial;\">&#8377;" +N+ "</a></h4>"); 
								session.setAttribute("amount",N);
							...
							if(count==0)
							{
								out.print("<h4 style=\"font-weight:700;text-align:center;margin-top:30px;\">Your Wallet:<a style=\"text-align:center;font-weight:400;font-family:arial;\">&#8377;0</a></h4>"); 
							}
						%>
				</div>
			</div>
