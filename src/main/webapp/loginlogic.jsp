...
<body>
	...
	<%		
			...
			if(count==1) {
			 ...
			 if(count==2){
				out.println("<h6 style=\"color:red;text-align:right;margin-right:380px;margin-top:-430px;font-weight:600;\">Incorrect Password</h6>");
			...
			if(count==0){
				out.println("<h6 style=\"color:red;text-align:right;margin-right:340px;margin-top:-430px;font-weight:600;\">Incorrect Username Or Password</h6>");
				RequestDispatcher rd=request.getRequestDispatcher("login.jsp");
				rd.include(request,response);
