...
<body>
	...
	<%		
			...
			if(count==1) {
			 ...
			 if(count==2){
				out.println("<h6 style=\"color:red;text-align:right;margin-right:440px;margin-top:-420px;font-weight:600;\">Incorrect Password</h6>");
			...
			if(count==0){
				out.println("<h4 style=\"color:red;text-align:center;margin-top:-680px\">You Don't Have Acc.</h4>");
